				...
				<slot name="headerBar">
					<view class="header__content" :style="headerBarContentStyle">
						...
						<view v-if="isShowMenu" class="header__menu" @click="showMenu">
							<image class="header__img header__img-menu" :src="menuImage"></image>
						...
						<slot name="headerTitle">
							<text :style="headerBarTitleStyle" class="header__title">{{ props.title }}</text>
						</slot>
					</view>
				</slot>
			</view>
...
const init = () => {
	...
	/* 通用平台 */
	// #ifndef MP-WEIXIN
	const customHeight = props.customNavHeight * safeAreaInsertInfo.scaleFactor + safeAreaInsertInfo.statusBarHeight;
